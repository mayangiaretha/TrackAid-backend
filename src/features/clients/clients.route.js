...
router.post('/',validate.client, asyncMiddleware(clientsControllers.createAClient));
router.get('/:id', asyncMiddleware(clientsControllers.getAClient));
router.get('/', asyncMiddleware(clientsControllers.getAllClients));
router.put('/:id', validate.client,asyncMiddleware(clientsControllers.updateClient));
